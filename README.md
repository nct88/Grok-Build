...
Phiên bản source hiện tại: **0.5.32** — xem [`product/VERSION`](product/VERSION).
...
|---|---|---|
| NSIS Setup | Cài vào Windows, tạo Start Menu/shortcut | [Grok-Build-Setup-0.5.32.exe](https://github.com/nct88/Grok-Build/releases/download/v0.5.32/Grok-Build-Setup-0.5.32.exe) |
| Portable EXE | Chạy dạng file tự giải nén | [Grok-Build-0.5.32-win32-x64-portable.exe](https://github.com/nct88/Grok-Build/releases/download/v0.5.32/Grok-Build-0.5.32-win32-x64-portable.exe) |
| Portable ZIP | Giải nén một lần, phù hợp dùng lâu dài | [Grok-Build-0.5.32-win32-x64.zip](https://github.com/nct88/Grok-Build/releases/download/v0.5.32/Grok-Build-0.5.32-win32-x64.zip) |
| Manifest | Kích thước và SHA-256 của artifact | [MANIFEST.json](https://github.com/nct88/Grok-Build/releases/download/v0.5.32/MANIFEST.json) |

Trang phát hành dự kiến: [Grok Build v0.5.32](https://github.com/nct88/Grok-Build/releases/tag/v0.5.32).
...
1. Tải `Grok-Build-Setup-0.5.32.exe` từ release.
