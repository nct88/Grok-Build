...
Current source version: **0.5.35** — see [`product/VERSION`](product/VERSION).
...
|---|---|---|
| NSIS Setup | Install on Windows with Start Menu and shortcut integration | [Grok-Build-Setup-0.5.35.exe](https://github.com/nct88/Grok-Build/releases/download/v0.5.35/Grok-Build-Setup-0.5.35.exe) |
| Portable EXE | Run as a self-extracting executable | [Grok-Build-0.5.35-win32-x64-portable.exe](https://github.com/nct88/Grok-Build/releases/download/v0.5.35/Grok-Build-0.5.35-win32-x64-portable.exe) |
| Portable ZIP | Extract once; recommended for regular use | [Grok-Build-0.5.35-win32-x64.zip](https://github.com/nct88/Grok-Build/releases/download/v0.5.35/Grok-Build-0.5.35-win32-x64.zip) |
| Manifest | Artifact sizes and SHA-256 values | [MANIFEST.json](https://github.com/nct88/Grok-Build/releases/download/v0.5.35/MANIFEST.json) |

Planned release page: [Grok Build v0.5.35](https://github.com/nct88/Grok-Build/releases/tag/v0.5.35).
...
1. Download `Grok-Build-Setup-0.5.35.exe` from the release.
