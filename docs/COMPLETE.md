...
| Channel | Path |
|---------|------|
| Installer | `dist/0.5.29/install/Grok-Build-Setup-0.5.29.exe` |
| Portable | `dist/0.5.29/portable/Grok-Build-0.5.29-win32-x64-portable.exe` |
| Zip | `dist/0.5.29/portable/Grok-Build-0.5.29-win32-x64.zip` |
| Update | `dist/0.5.29/update/` |
| Manifest | `dist/0.5.29/MANIFEST.json` · `dist/latest.json` |
